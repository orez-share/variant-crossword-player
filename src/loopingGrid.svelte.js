// Module for the `LoopingGrid` class
...
export default class LoopingGrid {
  ...
  progress = $derived(this.#gridObj.progress);
  normalizeCoordFmt = (args) => this.#gridObj.normalizeCoordFmt(args);
  prevWordFrom = (args) => this.#gridObj.prevWordFrom(args);
  nextWordFrom = (args) => this.#gridObj.nextWordFrom(args);
